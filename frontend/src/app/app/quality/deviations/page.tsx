...
export default function Deviations() {
  return (
    <EntityWorkspace
      eyebrow="QUALITY"
      title="Deviations"
      description="Record quality deviations with risk and immediate-action context."
      endpoint={endpoints.deviations}
      fields={[
        ...
        { key:"source_oos", label:"Source OOS", type:"select", optionsEndpoint:endpoints.oos },
        { key:"detected_at", label:"Detected date", type:"date" },
